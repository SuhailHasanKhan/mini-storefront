...
export async function GET() {
  const products = [
    ...
    { id: 'p2', name: 'Couch', price: 3500, category: 'Furniture', stock: 31 },
    ...
    { id: 'p9', name: 'Dining Table', price: 1950, category: 'Furniture', stock: 2 },
    { id: 'p10', name: 'Air Fryer', price: 120, category: 'Home', stock: 41 },
    { id: 'p11', name: 'Bar Stools', price: 80, category: 'Furniture', stock: 22 },
    { id: 'p12', name: '120 Inch TV', price: 7280, category: 'Electronics', stock: 67 }
  ];
